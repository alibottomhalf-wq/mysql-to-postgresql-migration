...
EXCEPTION WHEN OTHERS THEN
    ...
    CALL sp_logexception(
        _message::text, 
        ''::text, 
        'sp_attendance_insupd_by_monthandyear'::varchar, 
        B'1', 
        B'0', 
        _result
    );
